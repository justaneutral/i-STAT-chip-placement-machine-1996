...
BOOL CSetupScreenDlg::OnInitDialog() 
{
  ...
  ReplacButton(RGB(0,255,0),IDC_BUTTON_setup_screen_fetcher_clamp,m_setup_screen_fetcher_clamp);
  ...
  ReplacButton(RGB(255,240,240),IDC_BUTTON_setup_screen_motor_setup_overhead_gantry_smac,m_setup_screen_motor_setup_overhead_gantry_smac);
  ReplacButton(RGB(255,240,240),IDC_BUTTON_setup_screen_overhead_gantry_jaws,m_setup_screen_overhead_gantry_jaws);
  ...
  ReplacButton(RGB(240,240,255),IDC_BUTTON_setup_screen_vision_wafer,m_setup_screen_vision_wafer);
  ReplacButton(RGB(240,240,255),IDC_BUTTON_setup_screen_vision_base,m_setup_screen_vision_base);
  ReplacButton(RGB(0,255,0),IDC_BUTTON_setup_screen_plunge_up_timing,m_setup_screen_plunge_up_timing);
...
HBRUSH CSetupScreenDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	HBRUSH hbr;
